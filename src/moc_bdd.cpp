...
const QMetaObject Bdd::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Bdd.data,
      qt_meta_data_Bdd,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Bdd::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Bdd.stringdata0))
        return static_cast<void*>(const_cast< Bdd*>(this));
